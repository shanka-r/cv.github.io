    ...
    <header class="d-print-none">
      <div class="container text-center text-lg-left">
        <div class="py-3 clearfix">
          <h1 class="site-title mb-0">Shankar Gavit</h1>
          <!-- <div class="site-nav">
            <nav role="navigation">
...
<div class="cover shadow-lg bg-white">
  <div class="cover-bg p-3 p-lg-4 text-white">
    <div class="row">
      <div class="col-lg-4 col-md-5">
        <div class="avatar hover-effect bg-white shadow-sm p-1"><img src="images/profile.jpg" width="200" height="200"/></div>
      </div>
      <div class="col-lg-8 col-md-7 text-center text-md-start">
        <h2 class="h1 mt-2" data-aos="fade-left" data-aos-delay="0">Shankar Gavit</h2>
  ...
  <div class="about-section pt-4 px-3 px-lg-4 mt-1">
    <div class="row">
      <div class="col-md-6">
        ...
        <p>Hello! I’m Shankar Gavit. I am passionate web developer seeking to build dynamic and user-friendly web experiences.</p>
      </div>
      <div class="col-md-5 offset-md-1">
        <div class="row mt-2">
          ...
          <div class="col-sm-8">
            <div class="pb-1 text-secondary">gvtsnu@gmail.com</div>
          </div>
          <div class="col-sm-4">
            <div class="pb-1">Phone</div>
          </div>
          <div class="col-sm-8">
            <div class="pb-1 text-secondary">+91 84590 60491</div>
          </div>
          <div class="col-sm-4">
            <div class="pb-1">Address</div>
          </div>
          <div class="col-sm-8">
            <div class="pb-1 text-secondary">Nashik Maharashtra India</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="work-experience-section px-3 px-lg-4">
    ...
    <div class="timeline">
      <div class="timeline-card timeline-card-primary card shadow-sm">
        <div class="card-body">
          <div class="h5 mb-1">Devloper <span class="text-muted h6">at NPiT Solition</span></div>
          <div class="text-muted text-small mb-2"> 1 Year Experience</div>
          <div>Developed Multiple Static & Dynamic Webpage.</div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="education-section px-3 px-lg-4 pb-4">
    ...
    <div class="timeline">
      ...
      <div class="timeline-card timeline-card-success card shadow-sm">
        <div class="card-body">
          <div class="h5 mb-1">Master of Computer Science<span class="text-muted h6"> Pursuing</span></div>
          <div class="text-muted text-small">from</div>
          <div>Bhonsala Military College,(Arts,Science& Commerce) Rambhumi Nashik</div>
        </div>
      </div>
      <div class="timeline-card timeline-card-success card shadow-sm">
        <div class="card-body">
          <div class="h5 mb-1">Bachelor of Computer Science</div>
          <div class="text-muted text-small">from</div>
          <div>Pune Vidyarthi Griha's Shriram Sadashiv Dhamankar Art's Commerce & Science College Nashik</div>
        </div>
      </div>
      <div class="timeline-card timeline-card-success card shadow-sm">
        <div class="card-body">
          <div class="h5 mb-1">Science and Mathematics</div>
          <div class="text-muted text-smal">from</div>
          <div>LATE.D.S.Patil Art's Commerce & Science College Dahiwel Tal Sakri District Dhule</div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="contant-section px-3 px-lg-4 pb-4" id="contact">
    ...
    <div class="row">
      <div class="col-md-7 d-print-none">
        <div class="my-2"><form action="https://formspree.io/f/mrgwegkz"
    method="POST">
  <div class="row">
    <div class="col-6">
  ...
  <button class="btn btn-primary mt-2" type="submit">Send</button>
      ...
      <div class="col">
        <div class="mt-2">
          ...
          <div class="pb-2 text-secondary">Anuchaya Nagar Peth Road Opp Nashik</div>
          <h3 class="h6">Phone</h3>
          <div class="pb-2 text-secondary">+91 84590 60491</div>
          <h3 class="h6">Email</h3>
          <div class="pb-2 text-secondary">gvtsnu@gmail.com</div>
        </div>
      </div>
    </div>
  </div>
    ...
    <footer class="pt-4 pb-4 text-muted text-center d-print-none">
      <div class="container">
        <div class="my-3">
          <div class="h4">Shankar Gavit</div>
